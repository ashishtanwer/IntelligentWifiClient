...
public class IntelligentWifiClient extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final Intent orientationMonitoringServiceIntent = new Intent(getApplicationContext(),
				OrientationMonitoringService.class);
		...
		startButton.setOnClickListener(new OnClickListener() {
			public void onClick(View src) {
				...
				startService(orientationMonitoringServiceIntent);
			}
		});
		...
		stopButton.setOnClickListener(new OnClickListener() {
			public void onClick(View src) {
				...
				stopService(orientationMonitoringServiceIntent);
			}
		});		
	}
   ...
   class WifiScanReceiver extends BroadcastReceiver {
	      public void onReceive(Context c, Intent intent) {
			List<ScanResult> wifiScanList = mWifiManager.getScanResults();
	         ...
	         wifiList.setAdapter(new ArrayAdapter<String>(getApplicationContext(),
